...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 15, 2026 at 03:11 AM
...
CREATE TABLE `orders` (
  ...
  `status` enum('pending','confirmed','preparing','delivered','cancelled') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
